...
exports.buildExpenseModal = buildExpenseModal;
function buildExpenseModal(config, userName) {
    return {
        type: 'modal',
        ...
        blocks: [
            ...
            },
            {
                ...
                element: {
                    ...
                    initial_option: config.app.currency === 'USD'
            ...
            },
            {
                ...
                text: {
                    type: 'mrkdwn',
                    text: '領収書はモーダル送信後にBotからDMします。その案内に沿って *必ず同じスレッド内* にアップロードしてください。',
                },
            },
        ],
    };
